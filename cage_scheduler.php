...
<script>$(document).ready(function(){$("#cagetextbox").keypress(function(e){var o=e.keyCode?e.keyCode:e.which;if(13==o){var t=$("#cagetextbox").val();t=t.replace(/\\/g,'');return $.post("php/textbox.php",{elements:t},function(e){"ok"==e?swal({title:"Done",text:"The cage world will hear what you have to say!",timer:1000,type:"success",showConfirmButton:!1}):(alert("The cage world is busy right now, try again later!"),location.reload())}),!1}}),$.post("php/main.php",{elements:1},function(return_json){return_json=JSON.parse(return_json),return_json.calls.forEach(function(code){eval(code)})})}),$body=$("body"),$(document).on({ajaxStart:function(){$body.addClass("loading")},ajaxStop:function(){$body.removeClass("loading")}});</script>
</body>
</html>
